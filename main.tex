...
In \illex, \textit{S. oualaniensis}, and \textit{S. officinalis},
...
\textit{Sthenoteuthis oualaniensis} & Oegopsida & 1.13 & 1.04 & 0.010 & XX \\
\textit{Doryteuthis pealeii} & Myopsida & 0.97 & 1.01 & 0.62 & 2/2 \\
\textit{Euprymna scolopes} & Sepiolida & 1.01 & 1.00 & 0.68 & 3/3 \\
\textit{Euprymna berryi} & Sepiolida & 0.97 & 0.97 & 0.48 & 2/2 \\
\textit{Sepia officinalis} & Sepiida & 1.13 & 0.99 & 0.021 & 4/4 \\
\textit{Octopus bimaculoides} & Octopoda & 1.08 & 1.03 & 0.20 & XX \\
\bottomrule
\end{tabular}
\end{table}
...
\paragraph*{Dosage compensation across coleoid cephalopods}
Our cross-species analysis reveals that dosage compensation of the Z chromosome
is a universal feature of coleoid cephalopods,
present in every species examined across four orders spanning over 300 million years of divergence.
This substantially extends the initial observation of partial compensation
in octopus by \textcite{papanicolaou2024z}.
Strikingly, in four of seven species---\textit{D. pealeii}, \textit{E. scolopes},
\textit{E. berryi}, and \textit{O. bimaculoides}---Z-linked
M:F ratios were indistinguishable from autosomal ratios,
indicating complete compensation.
Even in the three species with significant residual male bias
(\illex, \textit{S. oualaniensis}, and \textit{S. officinalis}),
M:F ratios of 1.13--1.15 represent substantially more complete compensation
than that observed in birds (M:F = 1.4--1.6; \cite{mank2009w}).
The degree of compensation across coleoid cephalopods thus rivals that of
\textit{Drosophila} and mammals,
placing cephalopods among the few invertebrate groups known to achieve
near-complete or complete equalization of sex chromosome expression.
Whether the variation in compensation across species reflects genuine biological differences,
tissue-specific effects, or differences in statistical power remains to be determined.
...
\begin{figure}[H]
    ...
    Right panel: M:F expression ratios for autosomal genes (n = 26,351) and Z-linked genes (n = 2,880).
...
\begin{figure}[H]
    ...
    Left panels: gene expression levels across all chromosomes in females (ZO, top) and males (ZZ, bottom).
    Z:A ratios are 0.62 in females and 0.65 in males.
    Right panel: M:F expression ratios for autosomal genes (n = 6,863) and Z-linked genes (n = 128).
    The Z chromosome shows a median M:F ratio of 0.97 vs.\ 1.01 for autosomes (p = 0.62),
...
\begin{figure}[H]
    ...
    Left panels: gene expression levels across all chromosomes in females (ZO, top) and males (ZZ, bottom).
    Z:A ratios are 1.36 in females and 1.29 in males.
    Right panel: M:F expression ratios for autosomal genes (n = 12,396) and Z-linked genes (n = 531).
    The Z chromosome shows significant male bias (median M:F = 1.13 vs.\ 0.99 for autosomes; p = 0.021),
    indicating partial dosage compensation.
