...
In every species examined, the pattern was consistent:
Z-linked gene expression in females was upregulated toward the level observed in males,
indicating active dosage compensation of the hemizygous Z chromosome (Figure~\ref{fig:cross_species_dc}).
Median male-to-female expression ratios for Z-linked genes ranged from XX to XX across species
(Table~\ref{tab:cross_species_dc}),
all significantly greater than the 0.5 ratio expected in the absence of compensation
but less than the 1.0 ratio expected under complete compensation.
In contrast, autosomal genes showed M:F ratios centered at 1.0 in all species,
...
The universality of this pattern across species separated by over 300 million years of evolution
demonstrates that dosage compensation of the Z chromosome is ancestral to coleoid cephalopods.
The consistency of incomplete---rather than complete---compensation across all species examined
suggests that partial upregulation of the female Z may represent a stable evolutionary equilibrium
rather than an intermediate stage toward full compensation.
...
A ratio of 1.0 indicates complete compensation; 0.5 indicates no compensation.}
\label{tab:cross_species_dc}
\begin{tabular}{lllrr}
\toprule
\textbf{Species} & \textbf{Order} & \textbf{Tissue} & \textbf{Z M:F ratio} & \textbf{n (F/M)} \\
\midrule
\textit{Illex illecebrosus} & Oegopsida & Mantle & 1.50 & XX \\
\textit{Sthenoteuthis oualaniensis} & Oegopsida & XX & XX & XX \\
\textit{Doryteuthis pealeii} & Myopsida & XX & XX & XX \\
\textit{Euprymna scolopes} & Sepiolida & XX & XX & XX \\
\textit{Euprymna berryi} & Sepiolida & XX & XX & XX \\
\textit{Sepia officinalis} & Sepiida & XX & XX & XX \\
\textit{Octopus bimaculoides} & Octopoda & XX & XX & XX \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{figure}[H]
    \centering
    %\includegraphics[width=\linewidth]{figures/figXX.pdf}
    \caption{Dosage compensation of the Z chromosome is conserved across coleoid cephalopods.
    Male-to-female expression ratios [log2(Fold Change)] for Z-linked genes (red)
    compared to autosomal genes (blue) in seven cephalopod species.
    In every species, Z-linked genes show partial upregulation in females,
    with M:F ratios intermediate between 0.5 (no compensation) and 1.0 (complete compensation).
    Species are ordered by phylogenetic position.}
