...
To investigate this, we used reciprocal best-hit (RBH) orthology mapping across four species
...
a complete COMPASS complex (SET1B, MEN1, BRE1, ING5, TDRD3, UBN1, BAHD1),
the histone acetyltransferase CREBBP/CBP,
the SWR1 H2A.Z remodeler Domino/SRCAP,
and the SAGA component SPT20.
...
Z-linked COMPASS genes, chromatin enrichment, and \textit{Zmast}/\textit{Zfest} lncRNAs
...
with COMPASS genes uniformly in the A (euchromatic) compartment.
