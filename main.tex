...
Notably, ROX8 is the \textit{Drosophila} protein
that binds the dosage compensation lncRNAs \textit{roX1} and \textit{roX2},
...
These include binding sites for ROX8
(the \textit{Drosophila} protein that binds the
dosage compensation lncRNAs \textit{roX1/roX2}),
SNF (a U1/U2 snRNP component with a role
in \textit{Drosophila} sex determination),
and MEX-5 (a germline P-granule regulator).
The two sites in the Poly(U) Sponge domain include
FBF-1, a Pumilio-family translational repressor
that controls germline sex determination in \textit{C. elegans}
by repressing \textit{fem-3}.
That the conserved binding sites in a sex-linked lncRNA
converge on proteins involved in dosage compensation and sex determination
in distantly related species is striking,
though whether these represent functional homology
or convergent co-option of a common regulatory toolkit remains open.

One speculative model is suggested by the parallel with \textit{Drosophila}:
in that system, the X-linked \textit{roX} lncRNAs
recruit the MSL protein complex,
...
We emphasize that this model is speculative
