...
\illex \comment{why not full species name?}, and identify its Z chromosome via synteny and coverage analyses.
...
(Spearman correlations across 500~kb sliding windows). \comment{are the stats in the next sentence related to this? A bit confusing as written}
