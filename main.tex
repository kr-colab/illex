...
\paragraph{Zfest: eight-species annotation and alignment.}
...
\paragraph{Conserved architecture and AMN antisense overlap.}
...
Only Block~1 is entirely AMN-free,
...
\paragraph{Conserved RBP binding sites in Zfest.}
...
The AMN-free Block~1 carries five conserved sites:
...
Block~2 (AMN antisense) carries 19 sites,
...
\paragraph{Zfest is structurally distinct from Zmast.}
...
ruling out a roX-like chromatin-targeting mechanism for either lncRNA.
Infernal searches with roX1 and roX2 covariance models
...
confirming that \textit{Zfest} is not a roX-like RNA.
...
\begin{figure}[tbp]
    ...
    the 5$^\prime$ Head (blue) is AMN-free,
    while subsequent domains correspond to AMN CDS12--13
...
\subsection*{Zfest annotation and alignment}
