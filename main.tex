...
\textcite{coffing2025cephalopod} discovered that LINE enrichment
is a conserved feature of cephalopod Z chromosomes:
in \textit{O. bimaculoides}, the Z harbors LINEs
at approximately twice the density of the autosomal background
(Mann-Whitney $p < 10^{-4}$),
...
This led Coffing et al.\ to propose LINE density
as a diagnostic signature of Z chromosomes across cephalopods.

Our RepeatMasker analysis of the \textit{O. bimaculoides} genome
extends this finding by characterizing the specific LINE families involved
and their relationship to sex-biased expression.
The Z chromosome has the highest LINE density of all 31 chromosomes
(30 autosomes + Z):
