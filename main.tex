...
all Z-linked chromatin genes showed balanced expression between sexes:
...
and all other Z-linked chromatin genes were non-significant.
...
\begin{table}[H]
\centering
\caption{Expression of Z-linked chromatin modifier genes
...
\begin{tabular}{llrrrr}
\toprule
\textbf{Gene} & \textbf{Pathway} & \multicolumn{2}{c}{\textbf{\textit{O. bimaculoides}}} & \multicolumn{2}{c}{\textbf{\textit{S. oualaniensis}}} \\
\cmidrule(lr){3-4} \cmidrule(lr){5-6}
 & & \textbf{log$_2$FC} & \textbf{$p_\text{adj}$} & \textbf{log$_2$FC} & \textbf{$p_\text{adj}$} \\
\midrule
SET1B & H3K4me & +0.18 & 0.474 & +0.10 & NS \\
MEN1 & MLL/H3K4me & +1.21 & 0.175 & +0.97 & $6.1 \times 10^{-3}$ \\
BRE1/RNF40 & H2Bub1 & +0.05 & 0.774 & --- & NS \\
ING5 & HBO1/MOZ & +0.15 & 0.571 & --- & NS \\
TDRD3 & Tudor reader & $-$0.32 & 0.386 & --- & NS \\
UBN1 & HIRA/H3.3 & +0.13 & 0.606 & --- & NS \\
BAHD1 & Heterochromatin & +0.23 & 0.628 & --- & NS \\
\midrule
CREBBP/CBP & HAT & +0.61 & 0.089 & --- & NS \\
Domino/SRCAP & SWR1/H2A.Z & +0.59 & 0.027 & --- & NS \\
SPT20 & SAGA & --- & --- & --- & NS \\
\bottomrule
\end{tabular}
\end{table}
...
Having established that chromatin genes are enriched on the Z chromosome
across species and that dosage compensation is universal and ancestral,
we next examined the expression patterns of chromatin modifiers in detail
in \textit{O. bimaculoides},
where we have the greatest statistical power
...
Among the 29 chromatin modifier isoforms
with significant sex-biased expression in \textit{O. bimaculoides},
16 were female-biased and 13 male-biased
...
deacetylases (SIRT5, CDYL, CBX5),
MLL complex members (RBBP5, KMT2E),
...
29 chromatin modifier isoforms show significant sex-biased expression,
